...
object Compiler {
    ...
    private fun looksActionable(line: String): Boolean {
        ...
        // Explicit declarations of a goal, identity or system are actionable even
        // without a first-person verb ("Goal: run a 5k", "Identity: someone who…").
        val declarations = listOf("goal:", "goal ", "identity:", "i am becoming", "become ")
        if (declarations.any { s.startsWith(it) }) return true
