...
object Serial {
    ...
    fun of(f: Flow): JSONObject = jsonOf(
        "table" to "flow", "id" to f.id, "title" to f.title, "anchor" to f.anchor, "createdAt" to f.createdAt
    )
    ...
    fun system(o: JSONObject) = Sys(
        o.string("id", newId()), o.stringOrNull("goalId"), o.string("title"), o.string("description"),
        Status.valueOf(o.string("status", "ACTIVE")), long(o, "createdAt")
    )
    ...
    fun habit(o: JSONObject) = Habit(
        ...
        orderIndex = o.optInt("orderIndex", 0), status = Status.valueOf(o.string("status", "ACTIVE")),
    ...
    fun review(o: JSONObject) = Review(
        o.string("id", newId()), ReviewKind.valueOf(o.string("kind", "WEEKLY")), o.string("periodLabel"),
        o.string("whatWorked"), o.string("whatDidnt"), o.string("systemChange"),
        o.string("identityEvidence"), long(o, "createdAt")
    )

    fun energy(o: JSONObject) = EnergyLog(
        o.string("id", newId()), o.string("date"), Checkpoint.valueOf(o.string("checkpoint", "MORNING")),
    ...
    fun project(o: JSONObject) = BlueprintProject(
        ...
        o.optInt("version", 1), o.string("state", "DRAFT"), long(o, "createdAt")
    )
    ...
    fun exportAll(repo: Repo): JSONObject {
    ...
    fun importAll(repo: Repo, root: JSONObject) {
        repo.deleteAllData()
