...
object Serial {
    ...
    fun habit(o: JSONObject) = Habit(
        ...
        rewardLastRated = o.stringOrNull("rewardLastRated"),
        ...
        environmentPrepReminderTime = o.stringOrNull("environmentPrepReminderTime"),
    ...
    fun checkIn(o: JSONObject) = CheckIn(
        ...
        o.stringOrNull("missReason"), o.stringOrNull("missReasonDetail"),
        long(o, "createdAt")
    )
    ...
    fun obstacle(o: JSONObject) = ObstaclePlan(
        ...
        o.string("thenText"), o.stringOrNull("category"),
        o.optInt("timesUsed", 0), o.stringOrNull("lastUsed"),
    ...
    fun review(o: JSONObject) = Review(
        ...
        o.stringOrNull("previousReviewId"), long(o, "createdAt")
    )
