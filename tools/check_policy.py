...
EXEMPT = {
    ...
    "appLockPinHash": "credential (salted PIN hash), lives in the secrets file",
    "whisperApiKey": "credential, lives in the secrets file",
    "notifPermissionAsked": "transient runtime permission state, not user data",
